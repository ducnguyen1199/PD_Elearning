			...
			<Fragment>
				<form className="AccountInfo">
					...
					<div className="form-group">
						...
						{errors.matKhau !== '' ? <div className="massage-error">{errors.matKhau}</div> : ''}
					</div>
					<div className="form-group">
						...
						<input
							...
							disabled
						/>
						{errors.hoTen !== '' ? <div className="massage-error">{errors.hoTen}</div> : ''}
					</div>
					<div className="form-group">
						...
						<input
							...
							disabled
						/>
						{errors.soDT !== '' ? <div className="massage-error">{errors.soDT}</div> : ''}
					</div>
					<div className="form-group">
						<label>Email </label>
						<input
							...
							disabled
						/>
						{errors.email !== '' ? <div className="massage-error">{errors.email}</div> : ''}
					</div>
				</form>
